  ...
  render() {
    ...
    let new_courses_array = this.state.courses.map((course) => (
      <div className="div_to_hold_one_course_info">
        <div className="div_course_id">{course.courseID}</div>
        <div className="div_course_name">{course.courseName}</div>
        <div className="div_course_section">{course.courseSection}</div>
        <input
          className="checkbox_for_each_course"
          type="checkbox"
          defaultChecked={
            this.state.courses_registered_boolean[course.courseID]
          }
          onChange={() => {
            let new_dummy_registered_courses_array =
              this.state.courses_registered_boolean;
            new_dummy_registered_courses_array[course.courseID] =
              !new_dummy_registered_courses_array[course.courseID];

            if (new_dummy_registered_courses_array[course.courseID] === true) {
